...
if(isset($_FILES['item_image']) && $_FILES['item_image']['error'] == 0){
	...
	VALUES ('$userId','$item_name','$description','$color','$imageName','$location_found','found','pending',NOW())";
...
<head>
<meta charset="UTF-8">
<title>Report Found Item | NISU Lost and Found Portal</title>
...
<div class="wrapper">
  ...
  <div class="main">
    ...
    <div class="form-card">
      ...
      <p>Fill in the details of the item you found.</p>
      ...
      <?php endif; ?>
       ...
       <form method="POST" enctype="multipart/form-data">
        ...
        <a href="user_dashboard.php" class="back-link">Cancel</a>
